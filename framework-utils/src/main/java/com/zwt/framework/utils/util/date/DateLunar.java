...
public class DateLunar {
    ...
    public String toString() {
        ...
        String yueStr = chineseNumber[month - 1];
        if(month==1){
            yueStr = "正";
        }else if(month==12){
            yueStr = "腊";
        }
        return yueStr + "月" + getChinaDayString(day);
    }


    public static void main(String[] args)throws Exception{
        SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd");
        Date date = sdf.parse("2016-01-16");
        DateLunar lunar=new DateLunar(date);
