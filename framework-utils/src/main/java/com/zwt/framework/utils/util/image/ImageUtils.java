...
public class ImageUtils {
    ...
    public final static void cut2(String srcImageFile, String descDir,
        ...
        try {
            ...
            if (srcWidth > 0 && srcHeight > 0) {
                ...
                // 循环建立切片
                // 改进的想法:是否可用多线程加快切割速度
                imageCutHelper(descDir, destWidth, destHeight, image, cols, rows);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
     ...
     * @throws IOException
     */
    private static void imageCutHelper(String descDir, int destWidth, int destHeight, Image image, int cols, int rows) throws IOException {
        ImageFilter cropFilter;
        Image img;
